...
namespace Sunflowerology.Content.Projectiles
{
    internal class SnowflakeProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Timer > 120f) // After 1 second, start fading out
            {
                Projectile.Kill(); // Remove the projectile when fully transparent
            }
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            float timerFactor = MathHelper.Min(60f, Timer) / 2f;
